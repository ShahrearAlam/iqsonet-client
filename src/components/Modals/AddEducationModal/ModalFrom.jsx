...
// redux
import { useAddEducationMutation } from '../../../feature/profile/profileApiSlice';
...
export default function ModalFrom({ setAddEducation }) {

    const { register, handleSubmit, reset } = useForm();
    const [isCurrentlyEducating, setIsCurrentlyEducating] = useState(true);
    ...
    const handleAddEducation = async (data) => {
        ...
        if (res?.data) {
            toast.success("Add Education Information");
