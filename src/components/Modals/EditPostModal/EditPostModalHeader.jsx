...
export default function EditPostModalHeader({ setPostAccessibility }) {
    const { profileData } = useSelector(state => state.profile);
    const { fullname, profilePicture } = profileData?.personal || {};
    return (
        <div className=" mb-3 px-1.5 flex items-center justify-between ">
            <div className="flex items-center gap-2">
                ...
                <div>
                    <div>
                        <h1 className=" text-sm font-medium">  {fullname ? fullname : profileData?.username}</h1>
